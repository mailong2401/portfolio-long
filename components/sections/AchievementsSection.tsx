import { Award, Rocket, Code, Users, GitBranch } from 'lucide-react';
...
export default function AchievementsSection() {
  ...
  const achievements: Achievement[] = [
    {
      id: 1,
      year: t('achievements.items.0.year') || '2024',
    ...
    {
      id: 2,
      year: t('achievements.items.1.year') || '2022',
    ...
    {
      id: 3,
      year: t('achievements.items.2.year') || '2020',
            ...
            {achievements.map((achievement, index) => (
              ...
              >
                ...
                >
                  ...
                  <div
                    className={`md:w-1/2 flex ${index % 2 === 0 ? 'md:justify-end' : 'md:justify-start'
                      }`}
                  >
                  ...
                  {/* Nội dung */}
                  <div
                    className={`md:w-1/2 flex ${index % 2 === 0 ? 'md:justify-start' : 'md:justify-end'
                      }`}
                  >
                    <div className="bg-background/50 rounded-xl p-6 border border-border/30 transition-all shadow-border-sm hover:shadow-border-md hover:border-normal-blue/30 w-full max-w-md">
                      <div className="flex items-center gap-3 mb-2">
                        <div
                          className={`p-2 rounded-lg bg-background/50 ${achievement.color}`}
                        >
                          {achievement.icon}
                        </div>
        ...
        <ScrollAnimation direction="up" delay={0.8} duration={0.6}>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            <div className="text-center p-6 bg-background/50 rounded-xl border border-border/30 hover:border-normal-yellow/50 transition-all shadow-border-sm hover:shadow-border-md group">
              ...
              <p className="text-primary-dim-fg">
                {t('achievements.stats.projects')}
              </p>
            </div>
